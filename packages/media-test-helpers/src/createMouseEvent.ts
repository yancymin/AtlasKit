...
export const createMouseEvent = (name: string, props: MouseEventProps = {}): MouseEvent => {
  ...
  if (document.createEvent) {
    ...
    event.initMouseEvent(name, true, true, window, 0, sx || 0, sy || 0,
                         cx || 0, cy || 0, false, false, false, false, mb || 0, null);
    return event;
  }

  return new MouseEvent(name, {button: mb, clientX: cx || 0, clientY: cy || 0});
};
