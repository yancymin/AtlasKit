...
describe('MediaEditor DefaultMouseInput', () => {
  ...
  const positionCalculator = (event: MouseEvent) => {  // custom position calculator for tests
  ...
  it('should report one click if left button is down and up', () => {
    ...
    element.dispatchEvent(createMouseEvent('mousedown', {mouseButton: 0, clientX: xStart, clientY: yStart}));
    window.dispatchEvent(createMouseEvent('mouseup'));
  });
  ...
  it('should report mouse move when the mouse is dragged', () => {
    ...
    element.dispatchEvent(createMouseEvent('mousedown', {clientX: xStart, clientY: yStart}));
    window.dispatchEvent(createMouseEvent('mousemove', {clientX: xMiddle, clientY: yMiddle}));
    window.dispatchEvent(createMouseEvent('mousedown', {mouseButton: 2, clientX: xMiddle, clientY: yMiddle}));
    window.dispatchEvent(createMouseEvent('mousemove', {mouseButton: 2, clientX: xMiddle, clientY: yMiddle}));
    window.dispatchEvent(createMouseEvent('mousemove', {mouseButton: 2, clientX: xMiddle, clientY: yMiddle}));
