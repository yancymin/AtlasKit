...
export class BitmapFragment {
  ...
  constructor(private readonly gl: WebGLRenderingContext,
              ...
              image: HTMLImageElement, supplementaryCanvas: HTMLCanvasElement) {
    this.position = {
      x, y, width, height,
      uTopLeft: 0.0, vTopLeft: 0.0, uBottomRight: 1.0, vBottomRight: 1.0
    };
  ...
  private createTexture(image: HTMLImageElement, supplementaryCanvas: HTMLCanvasElement): WebGLTexture {
    ...
    const context = supplementaryCanvas.getContext('2d') as CanvasRenderingContext2D;
