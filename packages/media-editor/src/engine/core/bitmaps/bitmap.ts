...
export class Bitmap {
  ...
  private applyToFragment<T>(fragmentIndex: number, action: (fragment: BitmapFragment) => T, notFound: T): T {
  ...
  private splitToFragments(img: HTMLImageElement, gl: WebGLRenderingContext,
                           supplementaryCanvas: HTMLCanvasElement, maxSize: number): Array<BitmapFragment> {
